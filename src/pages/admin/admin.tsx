  ...
  return (
    <div className="p-8 min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-12">
        ...
        {galeriList.length === 0 && <p className="text-gray-400">Belum ada galeri yang diunggah.</p>}
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        {artikelList.length === 0 && <p className="text-gray-400">Belum ada artikel yang diunggah.</p>}
      </div>
    </div>
  );
}
