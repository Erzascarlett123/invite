...
export default function PpdbInfoPage() {
  ...
  return (
    <div className="pt-24 px-6 pb-16 min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
      <h1 className="text-4xl text-center font-bold text-green-300 drop-shadow-md">
        Informasi PPDB Online
      </h1>
      <p className="text-gray-300 mt-2 text-center text-sm mb-8 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto items-center mb-16">
        <div className="relative group perspective">
          <div className="transform transition-transform duration-500 group-hover:rotate-y-3d bg-white rounded-lg shadow-lg overflow-hidden">
            <video
              src={Video1}
              autoPlay
              loop
...
<div className="bg-white text-black p-6 rounded-lg shadow">
  <h2 className="text-xl font-bold text-black-400 mb-4 text-center">
    Periode Pendaftaran
  </h2>
